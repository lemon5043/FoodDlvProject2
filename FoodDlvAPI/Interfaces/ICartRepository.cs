...
namespace FoodDlvAPI.Interfaces
{
    public interface ICartRepository
    {
        ...
        /// <returns></returns>
        bool IsExists(long memberId, int storeId);
        ...
        /// <param name="memberId"></param>
        /// <returns></returns>
        CartDTO CreateNewCart(long memberId, int storeId);
        ...
        /// <param name="memberId"></param>
        /// <returns></returns>
        CartDTO Load(long memberId, int storeId);
        ...
        /// </summary>
        /// <param name="memberId"></param>
        void EmptyCart(long memberId, int storeId);
